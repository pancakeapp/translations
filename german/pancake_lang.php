...
$lang["error:sending_details"] = "Sende Details...";
$lang["error:response_will_be_sent_to_email"] = "Sie werden über Antworten per {email} benachrichtigt.";
$lang["settings:errors_and_diagnostics"] = "Fehler & Diagnose";
$lang["error:already_reported"] = "Dieser Fehler wurde bereits dem Pancake-Support gemeldet.";
...
$lang["projects.create.title"] = "Projekt erstellen";
$lang["projects.edit.title"] = "Projekt updaten";
$lang["projects.label.name"] = "Name:";
$lang["projects.label.client"] = "Kunde:";
$lang["projects.label.due_date"] = "Fälligkeitsdatum:";
$lang["projects.label.rate"] = "Stundensatz:";
$lang["projects.label.description"] = "Beschreibung:";
$lang["projects.label.is_viewable"] = "Im Kundenbereich anzeigen?";
$lang["projects.button.create"] = "Projekt erstellen →";
$lang["projects.create.succeeded"] = "Das Projekt wurde erstellt!";
$lang["projects.button.edit"] = "Projekt updaten →";
$lang["projects.button.delete"] = "Projekt löschen →";
$lang["projects.update.succeeded"] = "Das Projekt wurde gespeichert!";
$lang["projects.delete.title"] = "Sind Sie sicher, dass Sie dieses Projekt löschen wollen?";
$lang["times.title"] = "Zeiten";
$lang["times.create.title"] = "Zeit hinzufügen";
$lang["times.label.start_time"] = "Startzeit:";
$lang["times.label.end_time"] = "Endzeit:";
$lang["times.label.date"] = "Datum:";
$lang["times.label.task_id"] = "Aufgabe:";
$lang["times.label.note"] = "Notiz:";
$lang["times.label.notes"] = "Notizen:";
$lang["times.button.create"] = "Zeit hinzufügen→";
$lang["times.create.succeeded"] = "Die Zeit wurde erfolgreich hinzugefügt!";
$lang["times.edit.succeeded"] = "Die Zeit wurde bearbeitet!";
$lang["global:estimates_unsent"] = "Ungesendet";
$lang["invoices:estimates_unsent"] = "Nicht gesendete Voranschläge";
$lang["error:not_enough_disk_space"] = "Nicht genug Speicherplatz";
$lang["error:cant_send_email"] = "E-Mail kann nicht gesendet werden";
$lang["error:not_enough_disk_space_explanation"] = "Ihr Datenbankserver (:1) hat nicht genügend speicher.";
$lang["error:you_cannot_report_this_error"] = "Sie können diesen Report nicht an den Pancake-Support übermitteln da ein Problem mit Ihrem Webserver vorliegt. Bitte informieren Sie Ihren Server-Administrator. Sie können ihm folgendes mitteilen:";
$lang["error:not_enough_disk_space_solutions"] = "Wenn Sie root-Zugriff auf den Datenbankserver haben, versuchen Sie das /tmp Verzeichnis zu leeren. Falls dies nicht funktioniert, versuchen Sie herauszufinden, wie viel Speicher von der Datenbank belegt ist und ob es möglich ist, Speicher freizugeben.";
$lang["error:cant_send_email_explanation"] = "Sie haben angegeben, Sendmail (:1) zum Versenden von E-Mails benutzen zu wollen. Entweder ist der Pfad zu sendmail inkorrekt oder etwas anderes ging schief.";
$lang["error:email_settings_not_valid"] = "Ihre E-Mail Einstellungen sind ungültig.";
$lang["error:cant_send_email_solutions"] = "Wenn Sie root-Zugriff zum Server haben, stellen Sie sicher, dass sendmail richtig installiert ist ";
$lang["error:server_error"] = "Server Fehler";
$lang["error:xcache_extension_broken"] = "Ihr Server hat ein Problem mit der XCache Erweiterung.";
$lang["error:xcache_extension_broken_explanation"] = "Es ging etwas schief während Ihr Server versucht hat, die XCache-Erweiterung zu laden. Dieses Problem besteht nicht im Zusammenhang mit Pancake aber es sorgt dafür, dass Pancake nicht richtig laufen kann.";
$lang["error:permissions_not_valid"] = "Es gibt ein Rechte-Problem auf Ihrem Server.";
$lang["error:no_tmp_dir_permissions_explanation"] = "Ihr Server ist so konfiguriert, dass es Pancake nicht erlaubt, temporäre Dateien zu schreiben :1.";
$lang["error:no_tmp_dir_permissions_solutions"] = "Wenn Sie Root-Zugriff haben, ändern Sie bitte die open_basedir Einstellung in Ihrer php.ini so dass :1 in der Liste der erlaubten Verzeichnisse aufgeführt wird.";
$lang["error:cant_php_mail_explanation"] = "Sie haben Pancake so konfiguriert, dass es die PHP mail() Funktion zum versenden von E-Mails verwenden soll. Leider funktioniert diese Methode nicht korrekt. Zwar benötigt diese Methode keine Konfiguration, sie wird aber auch nicht emfpohlen. Der Grund liegt darin, dass der Empfänger-E-Mail Server nicht verifizieren kann, wer die E-Mail sendet. Das bedeutet, dass einige E-Mails sofort als Spam markiert werden. Es ist empfohlen, die E-Mail Einstellungen unter 'Einstellungen' > 'Emails' so zu verändern, dass einer der SMTP-Optionen genutzt werden. Alternativ (und als allerletzte Möglichkeit) können Sie die Sendmail-Option nutzen. Wenn keine Möglichkeit davon funktioniert, müssen Sie Ihren Server-Administrator kontaktieren.";
$lang["invoices:see_payment_schedule_below"] = "Siehe Zahlplan unten";
$lang["invoices:see_payment_schedule"] = "Siehe Zahlplan";
$lang["error:page_not_found"] = "Seite wurde nicht gefunden";
$lang["error:page_does_not_exist"] = "Die Seite, die Sie aufgerufen haben, existiert leider nicht.";
$lang["error:page_does_not_exist_explanation"] = "Sie wollten die Seite :1 aufrufen. Jedoch existiert diese nicht. Falls dies ein unerwarteter Fehler war, können Sie ihn an den Pancake Support weiterleiten. Nutzen Sie diese Möglichkeit unter 'Einstellungen' > 'Fehler & Diagnose'.";
$lang["settings:importedcredit_notes"] = "Importieren von :1 Anmerkungen erfolgreich.";
$lang["reports:per_payment_method"] = "pro Zahlmethode";
$lang["gateways:just_for_logging"] = "Beachten Sie: Diese Zahlmethode wirkt sich in keiner Wiese auf Rechnungen aus.
Sie existiert, damit Sie automatische Zahlungseingänge von :1 erhalten können.";
$lang["projects:no_data_provided"] = " Sie haben keine Informationen zum Erstellen eines Projekts aus einem Template eingegeben.";
$lang["projects:invalid_template"] = " Sie haben kein gültiges Projekttemplate ausgewählt.";
$lang["settings:test_email_subject"] = "Dies ist eine Test E-Mail.";
$lang["settings:test_email_message"] = "Dies ist eine Test E-Mail. Wenn Sie sie erreicht hat bedeutet dass, das Pancakes E-Mail Funktion funktioniert.";
$lang["settings:send_test_email"] = "Sende Test E-Mail";
$lang["settings:sending"] = "Sende E-Mail...";
$lang["settings:test_email_sent"] = "Senden zu :1 war erfolgreich!";
$lang["settings:test_email_error_header"] = "Versenden der E-Mail ist fehlgeschlagen..";
$lang["settings:test_email_error"] = "Während des Versendens der E-Mail ist ein Fehler aufgetreten:
...
$lang["settings:test_email_connection_error"] = "Ihr Server kann keine Verbindung zu :1 auf Port :2 herstellen. Sie sollten Kontakt zu Ihrem Server-Administrator herstellen um den entsprechenden Port in der Firewall freizugeben.

Die Fehlermeldung war:

:3";
$lang["invoices:all_unpaid"] = "Alle unbezahlten";
$lang["items:select_flat_rate"] = "Flatrate";
$lang["kitchen:no_tickets_created"] = "Keine Tickets erstellt.";
$lang["kitchen:responses"] = "Antworten";
$lang["kitchen:x_responses"] = ":1 Antworten";
$lang["projects:add_new_task"] = "Neue Aufgabe hinzufügen";
$lang["projects:delete_project_template"] = "Projekttemplate löschen";
$lang["expenses:supplier_edited"] = "Erfolgreich! Der Lieferant wurde erfolgreich bearbeitet.";
$lang["global:show_hide_deleted"] = "Gelöschte anzeigen/verstecken";
$lang["expenses:supplier_name"] = "Lieferanten-Name";
$lang["expenses:category_name"] = "Kategoriebezeichnung";
$lang["expenses:category_edited"] = "Erfolgreich! Die Kategorie wurde erfolgreich bearbeitet.";
$lang["expenses:before_you_can_add_expenses"] = "Bevor Sie Ausgaben hinzufügen können, müssen Sie :1 und :2 erstellen.";
$lang["reminders:no_due_date"] = "Kein Fälligkeitsdatum";
$lang["reminders:x_days_past_due"] = ":1 Tage überfällig";
$lang["search:results_for_x"] = 'Suchresultate für ":1"';
$lang["search:one_matching_result"] = "1 Suchergebnis";
$lang["search:x_matching_results"] = ":1 Suchergebnisse";
$lang["global:project_expense"] = "Ausgabe";
$lang["global:project_task"] = "Aufgabe";
$lang["global:ticket"] = "Ticket";
$lang["tickets:added"] = "Das Ticket wurder erfolgreich erstellt.";
$lang["tickets:replied"] = "Die Antwort auf das Ticket wurde erfolgreich gespeichert.";
$lang["tickets:user_updated_ticket"] = ":1 hat den Ticketstatuts zu :2 von :3 bearbeitet.";
$lang["global:reply"] = "Antworten";
$lang["global:attach_file"] = "Datei hinzufügen. (Maximale Größe: :1)";
$lang["global:download_csv"] = "CSV Downloaden";
$lang["reports:uncollected"] = "Nicht abgeholt";
$lang["reports:collected"] = "Abgeholt";
$lang["clients:filter_clients"] = "Kundenfilter";
$lang["users:deactivate"] = "Deaktivieren";
$lang["users:activate"] = "Aktivieren";
$lang["global:group"] = "Gruppe";
$lang["users:edit_user"] = "Benutzer bearbieten";
$lang["users:please_enter_information"] = "Bitte geben Sie die Benutzerdaten unten ein.";
$lang["users:confirm_password"] = "Passwort bestätigen";
$lang["invoices:not_associated_with_a_project"] = "-- Nicht mit einem Projekt verknüpft --";
$lang["global:by_x_with_time"] = "Von :1, :2.";
$lang["tasks:add_notes"] = "Notiz hinzufügen";
$lang["tasks:complete_this_task"] = "Diese Aufgabe vervollständigen";
$lang["tasks:task_notes"] = "Aufgaben-Notizen";
$lang["tasks:discuss_task"] = "Aufgabe diskutieren";
$lang["tickets:leave_a_response"] = "Antwort verfassen";
$lang["tickets:active_tickets"] = "Aktive Tickets";
$lang["projects:rate_type"] = "Satztyp";
$lang["projects:hourly_rate"] = "Stundensatz";
$lang["global:bcc_was_sent_to"] = "Diese E-Mail wurde am :2 zu :1 gesendet.";
$lang["global:server_default"] = "Server Standard (Nicht empfohlen)";
$lang["error:fixed_in_version"] = "Dieser Fehler wurde in Pancake {version} behoben. Falls Sie noch nicht geupdatet haben: bitten tun Sie es jetzt.";
$lang["error:no_user_found"] = "Ihr Lizenzschlüssel konnte nicht mit einem bestehenden Benutzer auf pancakeapp verknüpft werden. Aus diesem Grund konnte der Fehler nicht automatisch abgeschick werden. Falls dieser Fehler unerwartet aufgetreten ist, sende eine E-Mail an support@pancakeapp.com (englisch). Wir helfen gerne weiter.";
$lang["error:already_being_dealt_with"] = "Dieser Fehler wurde bereits von jemand anderem gemeldet. Aktuell arbeiten wir an einer Fehlerbehebung.";
$lang["error:php_outdated"] = "Die von Ihnen verwendete PHP-Version ist veraltet.";
$lang["error:using_php_53"] = "Sie nutzen PHP in der Version 5.3 welche seit mehr als 3 Jahren als veraltet gilt. Es hat den End-Of-Life Status erreicht. Das bedeutet, dass es keine Updates von der PHP Group geben wird.";
$lang["error:pancake_will_stop_supporting_it"] = "Pancake wird in ein paar Wochen den Support dafür einstellen.";
$lang["error:using_php_54"] = "Sie nutzen PHP in der Version 5.4. Diese Version ist seint mehr als 2 Jahren veraltet. Es wird den End-Of-Life Status im September 2015 erreichen. Das bedeutet, dass es ab diesem Zeitpunkt keine Updates von der PHP Group mehr geben wird.";
$lang["error:why_update"] = "Wenn Sie diese Version von PHP weiter verwenden, erhalten Sie keine Performance- und Sicherheitsupdtes mehr.";
$lang["error:upgrade_php"] = "Sie sollten Ihre PHP-Version mindestens auf die Verion 5.5 (besser 5.6) aktualisieren. Wie das geht, kann ihnen Ihr Server Administrator mitteilen.";
$lang["error:scan_pancake"] = "Pancake nach dateibezogenen Fehlern durchsuchen";
$lang["error:scan_pancake_explanation"] = "Manchmal entstehen Fehler weil Updates nicht richtig eingespielt werden konnten oder weil Rechteprobleme ein Update verhindern. Benutzen Sie diesen Check um solche Probleme im vorhinein herauszufinden.";
$lang["error:scanning"] = "Scanne... bitte warten.";
$lang["error:unknown_error_scanning"] = "Ein unbekannter Fehler ist während des Scannens aufgetreten.";
$lang["error:scan"] = "Scan";
$lang["error:scan_result_success"] = "Ihre Pancake-Installation ist in einem perfektem Zustand. Alles scheint OK zu sein.";
$lang["error:scan_result_failure_deleted_one"] = ":1 Datei existiert nicht";
$lang["error:scan_result_failure_deleted_other"] = ":1 Dateien existieren nicht";
$lang["error:scan_result_failure_modified_one"] = ":1 Datei wurde geändert";
$lang["error:scan_result_failure_modified_other"] = ":1 Dateien wurden geändert";
$lang["error:scan_result_failure_heading"] = "Es gibt Probleme mit einigen Pancake-Dateien.";
$lang["error:scan_result_failure_how_to_fix"] = "Um diese Fehler zu beheben, müssen Sie Pancake manuell updaten.";
$lang["error:click_here_for_instructions"] = "Klicken Sie hier für mehr Inforamtionen darüber.";
$lang["error:and_x_others"] = "... und :1 andere.";
