 ...
 * @since       Version 1.0
 *
 *@translation: Martin Kapma, http://www.albruna.nl
 */
...
$lang = array(
    ...
    'global:upload_failed'			=> 'Er is een fout opgetreden bij het uploaden van uw bestand. Probeer het opnieuw. Wanneer het probleem blijft bestaan, neem dan contact op met albruna@albruna.nl',
	...
	'global:start'					=> 'Start',
	'global:stop'					=> 'Stop',
    'global:start_timer'			=> 'Start Tijdklok',
    'estimates:create' => "Nieuwe offerte",
	'global:stop_timer'				=> 'Stop Tijdklok',
	...
	'global:greetings'	=>	array('Hoi!', 'Hallo,', 'Hey daar,', 'Sup,'),
        ...
        'global:mark_as_accepted' => 'Markeer als geaccepted',
        'global:mark_as_rejected' => 'Markeer als afgewezen',
        'global:reject_estimate' => 'Wijs offerte af',
        'global:accept_estimate' => 'Accepteer offerte',
        'global:estimate_rejected' => 'Offerte Afgewezen',
        "global:estimate_accepted" => "Offerte Geaccepteerd",
        'global:reject_proposal' => 'Wijs voorstel af',
        'global:accept_proposal' => 'Accepteer voorstel',
        ...
        'global:viewable' => 'Zichtbaar in het klantengedeelte',
        'global:not_viewable' => 'Niet zichtbaar in het klantengedeelte',
	...
	'invoices:markassent'			=> 'Markeer als verzonden',
        ...
        'invoices:date_created' => "Gecreeerd op datum",
        'invoices:size' => "Size",
	...
	'invoices:overdue'				=>	'Achterstallige facturen',
        'invoices:tax_collected' => "BTW binnengekomen",
	...
	'estimates:noestimatebody'		=>	'Dit zou je eigenlijk nog moeten doen! Wil je er eentje aanmaken?',
	...
	'estimates:send_now_body'		=> 'Vul het onderstaande formulier in en we verzenden deze offerte direct naar u.',
	'estimates:send_now'			=>	'Verzend offerte',
	'estimates:edit'				=>	'Bewerk offerte',
	'estimates:preview'				=>	'Voorvertoning offerte',
	'estimates:editestimate'		=>	'Bewerk offerte #:1',
	'estimates:messageupdated'		=>	'De offerte is bijgewerkt!',
    'estimates:client_viewed'		=>	':1 bekeken <a href=":2">offerte #:3</a> op :4',
	...
	'milestones:delete'				=> 'Verwijder Mijlpaal',
    ...
    'milestones:add_failed'			=> 'Mijlpaal ":1" kon niet worden bewerkt.',
    ...
    'reports:paid_vs_unpaid_over_time' => "Betaald versus Onbetaald over een periode",
    'reports:per_client' => 'per klant',
    'reports:total_with_tax' => "Totaal (m/ BTW)",
    'reports:total_without_tax' => "Totaal (geen BTW)",
    ...
    'currencies:cad'		=> 'Canadesian Dollar',
    'currencies:eur'		=> 'Euro',
    ...
    /** Proposals **/
    'proposals:duplicated'				=> 'Voorstel #:1gekopieerd. Het nieuwe voorstelnummer is #:2.',
    ...
    'proposals:client_rejected'		=>	':1 wees <a href=":2">voostel #:3</a> af op :4',
    ...
    'proposals:proposal_title' => 'Voostel titel',
	...
	'tasks:timers_running'				=>	'Tijdklok loopt',
...
'tasks:billed_hours' => "Gefactureerde uren",
	...
	'expenses:filter'					=>	'Filter uitgaven',
	...
	'timesheet:view_pdf'			=> 'Bekijk tijdrooster',
	...
	'tickets:updated_status'		=>	':1 werkte de ticketstatus bij naar :2',
        'tickets:add_a_new_ticket' => "Voeg een nieuwe Ticket toe",
        'tickets:create_a_new_ticket' => 'Creeer een nieuwe Ticket',
        'tickets:add_ticket' => 'Voeg Ticket Toe',
        'tickets:assign_to_user' => 'Wijs toe aan Gebruiker',
	...
	'frontend:contactadminforassistance'	=> 'Probeer dit eerst of neem contact op met :1 @ :2 voor assistentie',
	/** End Frontend **/
    ...
    'settings:file_should_be_csv'					=> 'Pancake zal automatisch het bestand verwerken en alles daarin importeren. Indien Pancake het bestand niet kan verwerken, wordt je daarvan op de hoogte gesteld en krijg je de mogelijkheid om ons informatie te sturen, zodat wij kunnen helpen om Pancake te laten werken met je bestand.',
    ...
    'settings:import'								=> 'Importeren (BETA)',
    ...
    'settings:noopenssl'							=> 'Je PHP server heeft geen OpenSSL geconfigureerd, wat betekend dat je geen gebruik kunt maken van Gmail of Google Apps om email te versturen. Neem contact op met je hosting provider om te zeggen dat je OpenSSL nodig hebt.',
    ...
    'settings:time_entry_times' => "Time Entry Tijden",
    "settings:include_dates_and_times_in_line_items" => 'Voeg data en tijden in "Time Entry" beschrijving in.',
    "settings:when_generating_invoice" => "Wanneer facturen worden gegenereerd, gebruik een line item per",
    "settings:use_utf8_font" => "Use UTF-8 font in PDFs",
    "settings:use_utf8_font_explanation" => "Gebruik dit als de karakters in je PDFs fout weergegeven worden.",
    "settings:pdf_attachments" => "PDF Bijlagen",
    "settings:pdf_attachments_explanation" => "Wanneer aangevinkt, zal Pancake de corresponderende PDF aan je factuur, offerte, voorstel e-mails toevoegen.",
    ...
    'settings:notify_email'			=> 'Kennisgevings e-mail',
    'settings:currency'				=> 'Valuta',
    'settings:theme'				=> 'Frontend thema',
    'settings:admin_theme'			=> 'Admin thema',
    'settings:admin_name'			=> 'Administrator naam',
    ...
    'update:errordownloading'				=> 'Er is een update voor Pancake bestchikbaar, maar er zijn momenteel problemen met het binnenhalen van deze update.',
    ...
    'update:loadpancakeagain'				=> "Herlaad Pancake. Als de fout blijft bestaan, verander de eigenaar van de Pancake folder (chown) zodat het overeenkomt met de web server's gebruiker. Als dat niet lukt of je weet niet hoe dit moet, stuur dan a.u.b. een e-mail naar support@pancakeapp.com en wij helpen je.",
    ...
    'update:pancakeneedsinternet'			=> 'Om Pancake goed te laten functioneren, moet je server toestaan om informatie van het internet te halen (poort 80).',
    'update:maybefirewall'					=> "Het lijkt erop dat je server Pancake geen toegang tot internet geeft. Dit kan komen door een firewall probleem op je server. Neem hiervoor contact op met je hosting provider. Vraag om PHP toegang tot :1.",
    ...
    'partial:wrongtotalbutsaved'		=> 'Het totaal van alle delen van je betaalplan komt niet overeen met het totale bedrag waarvoor je een factuur verstuurt.<br />De veranderingen aan je factuur zijn opgeslagen, maar je moet je betaalplan aanpassen.',
    'partial:problemsavingbutsaved'		=> 'Er is een probleem ontstaan met het opslaan van je betaalplan. Probeer het nogmaals.<br />De veranderingen aan je factuur zijn opgeslagen, het is alleen je betaalplan dat niet is opgelsagen.',
    'partial:savepaymentdetails'		=> 'Sla betaal details op',
    'partial:partpaidthanks'			=> "Dit gedeelte van je factuur is betaald. Bedankt.",
    'partial:proceedtopayment'			=> 'Ga verder met de betaling',
    'partial:topaynowgoto'				=> 'Om nu te betalen, ga naar :1',
    'partial:pay_part_x_now' => "Betaal deel #:1 van je factuur nu",
    'partial:dueondate'					=> 'verschuldigd voor :1',
    'partial:paymentmethod'				=> 'Betaalmethode',
    'partial:paymentdate'				=> 'Betaaldatum',
    'partial:paymentstatus'				=> 'Betaalstatus',
    'partial:transactionid'				=> 'Transactie ID',
    'partial:markaspaid'				=> 'Markeer als betaald',
    ...
    'banktransfer:banktransfer'			=> 'Bank Overschrijving',
    'gateways:errorupdating'			=> 'Er was een probleem met het updaten van je betaalmethode instellingen. Neem contact op met support.',
    'gateways:paymentmethods'			=> 'Betaalmethoden',
    'gateways:selectpaymentmethod'		=> 'Selecteer Betaalmethode',
    'gateways:nogatewayused'			=> 'Geen betaalmethode gebruikt: Gedeelte is niet betaald',
    ...
    'gateways:rejectedemail'			=> 'Pancake was op de hoogte geseteld van een :1 betaling welke een klant (:2) deed, maar :1 heeft het afgewezen.',
    'gateways:pending'					=> 'In afwachting',
    ...
    'gateways:payment_details'			=> 'Betaal details',
    'gateways:api_signature'			=> 'API Signatuur',
    'gateways:api_password'				=> 'API Wachtwoord',
    'gateways:api_username'				=> 'API Gebruikersnaam',
    /** End Payment Gateways **/

    /** Kitchen Area **/
    'kitchen:edit_comment'				=> 'Bewerk reactie',
    'kitchen:add_a_comment' => "Voeg een reactie toe",
    'kitchen:kitchen_name' 				=>  'Klantenomgeving',
    'kitchen:pleaselogin' 				=>  'Vul uw wachtwoord in om toegang tot uw account te krijgen',
    ...
    'kitchen:submitcomment'				=>  'Voeg reactie toe',
    'kitchen:attachment'    			=>  'Bijlage',
    'kitchen:saidon'    				=>  'Gezegd op :1, om :2',
    'kitchen:subjectinvoice'			=> 'Nieuwe reactie voor Factuur #',
    'kitchen:subjectestimate'			=> 'Nieuwe reactie voor Offerte #',
    'kitchen:subjectproject'			=> 'Nieuwe reactie voor Project:',
    'kitchen:subjecttask'				=> 'Nieuwe reactie voor Taak:',
    'kitchen:subjectproposal'			=> 'Nieuwe reactie voor Voorstel:',
    'kitchen:backtodashboard'   		=>  'Terug naar het Dashboard',
    'kitchen:client_welcome'    		=>  'Klantenomgeving van:',
    'kitchen:urltosend'					=>  'Klanten toegangslink',
    'kitchen:nopassphrase'  			=>  'Momenteel is er geen "Wachtwoord" ingesteld, dit betekent dat het benaderen van de url genoeg is om het klantengedeelte te bekijken. Als je dat gedeelte wilt beveiligen, bewerk de klantendetails en maak een wachtwoord aan.',
    'kitchen:passphraseset'				=>  'Deze klant heeft een wachtwoord',
    'kitchen:passphrase'    			=>  'Wachtwoord',
    'kitchen:description'   			=>  'Dit is de url om naar je klant te sturen waarmee deze toegang heeft tot diens klantenomgeving waar zaken zoals facturen, projecten, voorstelen etc. bekeken kunnen worden.',
    ...
    'store:buy' => "Koop ($:1)",
    'store:update' => "Update",
    'store:install' => "Installeer",
    'store:settings' => "Instellingen",
    'store:already_bought' => "Je hebt dit item reeds gekocht!",
    'store:installed_successfully' => "Je hebt de :1 :2 successvol geinstalleerd.",
    'store:plugin' => "Plugin",
    'store:payment_gateway' => "Betaaltoegang",
    'store:frontend_theme' => "Frontend Thema",
    'store:backend_theme' => "Backend Thema",
    'store:unknown' => "Onbekend",
    'store:updatestoreitems' => "Update winkel items",
    'store:download_free' => "Download (GRATIS)",
    'store:error1000' => "Je authorisatie sleutel is niet langer geldig. Je zal je betaalinformatie opnieuw in pancakeapp.com in moeten voeren.",
    'store:error1001' => "Je hebt dit artikel reeds gekocht!",
    'store:error1002' => "Er is een probleem ontstaan met het afschrijven van geld van uw creditcard. Probeer het later nogmaal.",
    'store:error1003' => "Je hebt een niet toegestane aanvraag gedaan.",
    ...
    'email_templates:invoice_payment_notification_for_admin' => 'Betaalnotificatie (gestuurd naar admin)',
    'email_templates:invoice_payment_notification_for_client' => 'Betalingskwitantienotificatie (gestuurd naar klant)',
    ...
    'global:timer_app' => "Pancake Tijdklok App",
    ...
    'invoices:converted_to_estimate' => "Factuur #:1 geconverteerd naar een offerte.",
    'global:converttoestimate' => 'Converteer naar een Offerte',
    # End v4.1.2 changes
    
    # Begin v4.1.3 changes
    'tickets:view_archived' => "Bekijk Gearchiveerde Tickets",
    'tickets:view_unarchived' => "Bekijk Actieve Tickets",
    'tickets:archiving_ticket' => "Archiveren van ticket",
    'tickets:unarchiving_ticket' => "Reactiveren ticket",
    "tickets:unknown_error_ticket_not_altered" => "Een onbekende fout is opgetreden. Je ticket is niet aangepast.",
    # End v4.1.3 changes
    
    # Begin v4.1.4 changes
    "tasks:starting_timer" => "Starten tijdklok",
    "tasks:stopping_timer" => "Stoppen tijdklok",
    ...
    "dashboard:written_by" => "Geschreven door :1 on :2",
    "dashboard:client_activity" => "Klanten Ativiteit",
    "dashboard:view_all_client_activity" => "Bekijk Alle Klanten Activiteit",
    ...
    "dashboard:what_the_team_is_working_on" => "Waar het team aan werkt.",
    # End v4.1.4 changes
    
    # Begin v4.1.6 changes
    "global:save_milestone" => "Sla Mijlepaal op",
    "global:save_task" => "Sla Taak op",
    "global:private_comment" => "Deze reactie is prive. Je klant zal deze niet zien.",
    "global:clients_cant_see_private" => "Klanten kunnen geen prive reacties zien.",
    "global:is_private" => "Prive?",
    # End v4.1.6 changes
    
    # Begin v4.1.7 changes
    "tickets:disable_client" => "-- Uitzetten Support Tickets --",
    # End v4.1.7 changes
    
    # Begin v4.1.8 changes
    "global:css" => "Custom CSS",
    "global:js" => "Custom JavaScript",
    "global:js_explanation" => "Je kan jQuery gebruiken. Je code zal worden toegevoegd voor &lt;/body&gt;.",
    ...
    "global:nolongerexists" => "[BESTAAT NIET LANGER]",
    "global:billed_amount" => "Gefactureerd bedrag",
    "global:unbilled_amount" => "Niet gefactureerde bedrag",
