...
Faturas não pagas ou pagas parcialmente são exibidas baseadas em sua data de emissão.',
  ...
  'settings:test_email_connection_error' => 'Ocorreu um erro ao tentar enviar o e-mail de teste:<br/><br/>:1<br/><br/>Por favor, verifique se os detalhes inseridos estão corretos. Se estiver usando SMTP, verifique se a porta que está tentando usar está aberta no firewall do servidor.',
  'kitchen:no_tickets_created' => 'Nenhum bilhete foi criado.',
  'projects:add_new_task' => ':1 Respostas',
  'items:select_flat_rate' => 'Tudo não pago',
  ...
  'error:fixed_in_version' => 'Esse problema foi corrigido no Pancake {versão}. Se você ainda não o fez, atualize seu Pancake.',
  'error:scan_pancake' => 'Analise seu Pancake para encontrar questões relacionadas a arquivos',
  'error:scan' => 'Digitalização',
  'error:scanning' => 'Digitalizando, por favor aguarde...',
  ...
  'error:unknown_error_scanning' => 'Ocorreu um erro desconhecido durante a digitalização.',
  ...
  'error:scan_result_failure_deleted_other' => ':1 dos arquivos não existem',
